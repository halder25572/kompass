...
export default function VerifyOtpPage() {
  ...
  const text = language === "de"
    ? {
      ...
      spamNote: "Bitte ueberpruefe deinen Spam-Ordner, falls du die E-Mail nicht erhaelst.",
    ...
    : {
      ...
      spamNote: "Please check your spam folder if you do not receive the email.",
      verifying: "Verifying...",
