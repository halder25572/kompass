...
//             Back to dashboard
//           </Link>
//           <span className="rounded-full border border-[#f3d4db] bg-white px-3 py-1 text-xs font-semibold text-[#BF003A]">Book ID {bookId}</span>
//         </div>
...
//                 <p className="mt-1 text-sm text-[#9CA3AF]">The current questionnaire loaded from the GET detail endpoint.</p>

//                 <div className="mt-4 space-y-3">
//                   {book.questions.length ? book.questions.map((question, index) => (
//                     <div key={`${question}-${index}`} className="rounded-2xl border border-[#ece7ea] bg-[#fafafa] px-4 py-3 text-sm text-[#374151]">
...
//                 <p className="mt-1 text-sm text-[#9CA3AF]">Use the loaded book data to continue editing or previewing.</p>
...
//             <InfoCard label="Expiry" value={new Date(book.expire_date).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })} />
//           </div>
