...
function Step4({ onNext, onBack, initialCoverId }: { onNext: () => void; onBack: () => void; initialCoverId?: number }) {
...
export default function BookCreator() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            {step === 3 && <Step4 onNext={() => setStep(4)} onBack={() => setStep(2)} initialCoverId={urlCoverId} />}
