...
//                 </button>
//             ) : (
//                 // Spacer to keep layout consistent when only 1 row
...
//     // Sensors: PointerSensor with distance constraint so input clicks don't trigger drag
...
//     const addFriend = () => {
//         setFriends(prev => [...prev, createFriend()]);
//     };
...
//     // Find the active friend for DragOverlay
...
//                     {/* Column Headers — only show when multiple friends */}
//                     {friends.length > 0 && (
//                         <div className="flex gap-2 px-2 mb-1">
//                             <div className="w-9 shrink-0" /> {/* drag handle spacer */}
...
//                             </div>
//                             <div className="w-9 shrink-0" /> {/* remove button spacer */}
//                         </div>
//                     )}
