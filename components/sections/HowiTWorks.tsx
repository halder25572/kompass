...
//                 <h2 className="text-[40px] font-extrabold">Four Simple Steps to a <span className="bg-[linear-gradient(102deg,#BF003A_0%,#59001C_100%)] bg-clip-text text-transparent">Beautiful Book</span></h2>
//                 <p className="text-[16px] mt-3 text-[#9CA3AF]">From creating your project to holding a printed book in your hands — the entire <br /> process is simple, collaborative, and magical.</p>
//             </div>
//             <div className="max-w-175 mx-auto flex flex-col gap-4">
//                 {steps.map((step, idx) => {
...
//                         <div
//                             key={idx}
//                             className="relative w-full bg-no-repeat mb-15"
//                             style={{
//                                 paddingBottom: "24.65%",
//                                 backgroundImage: `url(${step.image})`,
//                                 backgroundSize: "100% 100%",
//                                 // marginLeft: !blobLeft ? "300px" : undefined,
//                                 marginLeft: !blobLeft ? "clamp(0px, calc((100vw - 1024px) * 300 / 376), 300px)" : undefined,
//                             }}>
//                             <div
//                                 className="absolute inset-y-0 flex flex-col justify-center gap-0.5 mt-5"
//                                 style={{
//                                     left: blobLeft ? "38%" : "24%",
//                                     right: blobLeft ? "3%" : "18%",
//                                 }}>
//                                 <h3
//                                     className="font-bold text-[#1a1a2e] mt-6.5"
...
export default function HowItWorksSection() {
    ...
    return (
        <section ref={sectionRef} className="bg-[#EEE] py-10 px-5">
