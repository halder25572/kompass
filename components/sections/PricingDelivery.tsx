...
//     {
//         icon: (
//             <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7A1E3A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
//     return (
//         <section className="bg-[#EEE8EA] py-12 px-4 sm:px-6 lg:px-8">
...
//             {/* Pricing Card */}
//             <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm overflow-hidden mb-6">

//                 {/* Cost per friend header */}
...
//                         <div
//                             key={idx}
//                             className={`flex items-center justify-between px-6 py-3 ${idx % 2 === 0 ? "bg-white" : "bg-[#fafafa]"}`}
//                         >
//                             <span className="text-[13px] text-[#374151]">{tier.range}</span>
//                             <div className="flex items-baseline gap-1">
//                                 <span className="text-[14px] font-bold text-[#7A1E3A]">{tier.price}</span>
...
//                             <div>
//                                 <p className="text-[12px] text-[#374151]">Photo page</p>
//                                 <p className="text-[10px] text-[#9CA3AF]">per 1–3 pages</p>
//                             </div>
//                             <span className="text-[13px] font-bold text-[#7A1E3A] shrink-0">€2.25</span>
//                         </div>
//                         <div className="flex items-start justify-between gap-2">
//                             <div>
//                                 <p className="text-[12px] text-[#374151]">Annual review</p>
//                                 <p className="text-[10px] text-[#9CA3AF]">per 7 pages</p>
//                             </div>
//                             <span className="text-[13px] font-bold text-[#7A1E3A] shrink-0">€2.25</span>
//                         </div>
//                     </div>
...
//                         You will receive a{" "}
//                         <span className="font-bold text-[#7A1E3A]">35% discount</span>{" "}
//                         on each additional identical family book.
//                     </p>
//                     <p className="text-[12px] text-[#374151] leading-relaxed mt-3">
//                         If you would like to order more than 15 copies, please{" "}
//                         <a href="#" className="text-[#7A1E3A] underline">contact us</a>{" "}
...
//                 <div className="text-center mb-8">
//                     <p className="text-[11px] font-bold text-[#7A1E3A] uppercase tracking-widest mb-2">
//                         Delivery Options
//                     </p>
...
//                             <div className="w-10 h-10 rounded-xl bg-[#f9f0f2] flex items-center justify-center">
//                                 {opt.icon}
//                             </div>
...
//                     <button className="flex items-center gap-2 bg-[linear-gradient(102deg,#BF003A_0%,#59001C_100%)] hover:opacity-90 text-white text-[14px] font-semibold px-8 py-3.5 rounded-full transition-opacity cursor-pointer">
//                         Start Your Book
...
export default function PricingDelivery() {
    ...
    return (
        <section ref={sectionRef} className="bg-[#EEE8EA] py-12 px-4 sm:px-6 lg:px-8">
