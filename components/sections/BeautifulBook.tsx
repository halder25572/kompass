...
//   return (
//     <section className="w-full py-16 px-4" style={{ backgroundColor: "#EEE" }}>
//       <div className="max-w-6xl mx-auto">

//         {/* Header */}
//         <div className="flex flex-col items-center text-center mb-10 gap-3">
//           <span className="text-[18px] font-bold tracking-[0.18em] uppercase text-[#7A1E3A]">
//             Templates
//           </span>
//           <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1a1a2e]">
//             Beautiful Book <span className="bg-[linear-gradient(102deg,#BF003A_0%,#59001C_100%)] bg-clip-text text-transparent">Designs</span>
//           </h2>
...
//             >
//               {/* Image */}
//               <div className="relative w-full h-44 bg-[#f3f4f6]">
//                 <Image
//                   src={tpl.image}
//                   alt={tpl.title}
//                   fill
